...
electronMVAVariableHelperLowPt = cms.EDProducer('GsfElectronMVAVariableHelper',
...
electronMVAValueMapProducerLowPt = cms.EDProducer(
...
egmGsfElectronIDsLowPt = cms.EDProducer(
...
egmGsfElectronIDTask = cms.Task(
    electronMVAVariableHelperLowPt,
    electronMVAValueMapProducerLowPt,
    egmGsfElectronIDsLowPt,
)
...
electronsForAnalysis = cms.EDProducer(
  ...
  #pfSrc    = cms.InputTag('slimmedElectronsFAKE'), #empty collection
  ...
  pfmvaId = cms.InputTag("electronMVAValueMapProducerLowPt:ElectronMVAEstimatorRun2BParkRetrainRawValues"),
...
electronBParkMCTable = cms.EDProducer("CandMCMatchTableProducerBPark",
    ...
    objName = cms.string("ElectronBPark"),
